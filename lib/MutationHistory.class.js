...
with(MutationHistory)
{
	...
	prototype.rangesBeforeMutations=[];
	prototype.rangesAfterMutations=[];
	...
	prototype.buildMutationsBatchRange=MutationHistory_buildMutationsBatchRange;
	prototype.selectMutationsBatchRange=MutationHistory_selectMutationsBatchRange;
	
	prototype.startMutationsBatch=MutationHistory_startMutationsBatch;
	prototype.endMutationsBatch=MutationHistory_endMutationsBatch;
...
function MutationHistory_buildMutationsBatchRange(mutationsBatchIndex, after)
{
	var range=this.getRange();
	var rangeType=after?"rangesAfterMutations":"rangesBeforeMutations";
	
	this[rangeType][mutationsBatchIndex]=range?{"startContainer": range.startContainer, "startOffset": range.startOffset, "endContainer": range.endContainer, "endOffset": range.endOffset}:null;
}
function MutationHistory_selectMutationsBatchRange(mutationsBatchIndex, after)
{
	var rangeType=after?"rangesAfterMutations":"rangesBeforeMutations";
	
	if(this[rangeType][mutationsBatchIndex])
	{
		this.setRange(this[rangeType][mutationsBatchIndex].startContainer, this[rangeType][mutationsBatchIndex].startOffset, this[rangeType][mutationsBatchIndex].endContainer, this[rangeType][mutationsBatchIndex].endOffset);
	}
}
function MutationHistory_startMutationsBatch()
{
	...
	this.buildMutationsBatchRange(this.mutationsBatchIndex);
}
function MutationHistory_endMutationsBatch()
{
	this.buildMutationsBatchRange(this.mutationsBatchIndex, true);
}
...
{	
	...
	this.selectMutationsBatchRange(this.mutationsBatchIndex);
...
function MutationHistory_redo()
{
	...
	this.selectMutationsBatchRange(this.mutationsBatchIndex, true);
