...
function MutationHistory(target, serializedHistory, selectionChangeObserver, DOMChangeObserver)
{
	...
	{
		this.target.addEventListener(MutationHistory.prototype.___pseudoOnSelectionChangeEvents[i], this.onSelectionChangedHandler2, false);
	}
...
function MutationHistory_release()
{
	for(var i=0; i<MutationHistory.prototype.___pseudoOnSelectionChangeEvents.length; i++)
	{
		this.target.removeEventListener(MutationHistory.prototype.___pseudoOnSelectionChangeEvents[i], this.onSelectionChangedHandler2, false);
	}
