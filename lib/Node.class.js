...
with(Node)
{
	...
	prototype.__html5Tags={
		...
		"OL": {"category": FLOW_CONTENT, "contentCategory": 0/*Zero or more li elements.*/},
		"UL": {"category": FLOW_CONTENT, "contentCategory": 0/*Zero or more li elements.*/},
		"LI": {"category": null, "contentCategory": ALL_CONTENT},
    ...
    If the element does not have a src attribute: one or more source elements, then, transparent.*/},
		...
		*/
		...
		//----Tabular data
		//"TABLE": {"category": [], "contentCategory": []},
		//"CAPTION": {"category": [], "contentCategory": []},
		...
		//"TR": {"category": [], "contentCategory": []},
		//"TD": {"category": [], "contentCategory": []},
...
function Node_cloneNode(cloneChildNodes)
{
	...
	window.parent.mh.observe(clone);
