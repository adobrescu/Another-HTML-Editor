...
function EditableContent_unhighlightParagraph(restoreRange)
{
...
function EditableContent_highlightCurrentParagraph()
{
	...
	if(startContainer)
	{
		boundary=this.getNodeParagraphLeftBoundary(startContainer);
	}
	if(!startContainer || !boundary)
	{
		this.unhighlightParagraph(true);
		
		return;
	}
	
	var par=this.getNodeParagraph(boundary);
