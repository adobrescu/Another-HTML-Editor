...
function EditableContent_surroundSelectedContentFragments(tagName, tagAttributes, select)
{
	...
	{
		this.addSelection(splitInfo[i].containers[0].container, 0, 
			splitInfo[i].containers[splitInfo[i].containers.length-1].container, 
			splitInfo[i].containers[splitInfo[i].containers.length-1].container.childNodes.length);
	}
