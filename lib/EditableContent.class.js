...
{
	var range;
	console.log("EditableContent_addSelection");
	range=this.window.document.createRange();
...
function EditableContent_getRanges()
{
	...
	{
		ranges[ranges.length]=this.window.getSelection().getRangeAt(i);
	}
	return ranges;
}
...
function EditableContent_surroundSelection(tagName, tagAttributes, select, expand)
{
	...
	{
		this.surroundContentFragment(tagName, tagAttributes, select,
...
function EditableContent_surroundContentFragment(tagName, tagAttributes, select, node, offset, rangeEndContainer, rangeEndOffset, expand)
{
	...
	{
		console.logNode(containers[0]);
		this.addSelection(containers[0], 0, containers[containers.length-1], containers[containers.length-1].childNodes.length);
	}
