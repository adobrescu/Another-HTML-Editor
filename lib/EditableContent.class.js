...
function EditableContent(iframe, innerHTML, serializedHistory)//always an iframe, need edited doc CSS in their own space
{
	...
	var editableContainers=this.documentContainer.ownerDocument.querySelectorAll("[contentEditable=true]");
	for(var i=0; i<editableContainers.length; i++)
	{
		...
		var notEditableContent=this.documentContainer.ownerDocument.createElement("X-FLOW-CONTENT-NOT-EDITABLE", true);
...
EditableContent.prototype.paragraphsEquals=EditableContent_paragraphsEquals;
