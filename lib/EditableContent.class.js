...
with(EditableContent)
{
	...
	prototype.splitNodeAtDescendant=EditableContent_splitNodeAtDescendant;
...
function EditableContent_getInlineNodesEdges(startNode, startOffset, endNode, endOffset, ca/*callback arguments*/, outerTagName, expand)
{
