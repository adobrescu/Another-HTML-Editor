...
with(EditableContent)
{
	...
	prototype.getRanges=EditableContent_getRanges;
	...
	prototype.getRangeBoundaries22=EditableContent_getRangeBoundaries22;
...
function EditableContent_getRanges()
{
	...
	{
		range=this.window.getSelection().getRangeAt(i);
		ranges[ranges.length]={"startContainer": range.startContainer, "startOffset": range.startOffset, "endContainer": range.endContainer, "endOffset": range.endOffset};
...
function EditableContent_surroundSelectedContentFragments(tagName, tagAttributes, select, expand)
{
	...
	{
		console.logNode(ranges[i].startContainer, "", "", "AICI: ("+ranges[i].startOffset+")");
		console.logNode(ranges[i].endContainer, "", "", "AICI: ("+ranges[i].endOffset+")");
		//continue;
