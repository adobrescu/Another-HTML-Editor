...
with(EditableContent)
{
	...
	prototype.collectTransparentContentEdges=EditableContent_collectTransparentContentEdges;
	prototype.collectNotPhrasingNodes=EditableContent_collectNotPhrasingNodes;
	prototype.collectInsertionBoundaries=EditableContent_collectInsertionBoundaries;
	prototype.stickAdjacentTextNodes=EditableContent_stickAdjacentTextNodes;
	prototype.normalize=EditableContent_normalize;
...
function EditableContent_surroundNodes(tagName, tagAttributes, select, node, offset, rangeEndContainer, rangeEndOffset)
{
	var args, containers;
	...
	args=this.getInsertionBoundaryNodes(node, offset, rangeEndContainer, rangeEndOffset, null, tagName);
...
function EditableContent_getInsertionBoundaryNodes(startNode, startOffset, endNode, endOffset, ca/*callback arguments*/, outerTagName, expand)
{
	...
	this.visitSelectedNodes([this, "collectInsertionBoundaries"], 
						...
						!Node.prototype.___tagIsPhrasingContent(outerTagName) || Node.prototype.___tagHasTransparentContent(outerTagName) || expand);
