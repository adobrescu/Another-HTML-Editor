...
function EditableContent_undo()
{
	...
	//console.log("Undo this.mutationHistory.historyCursor="+this.mutationHistory.historyCursor);
	this.mutationHistory.undo(1);
...
function EditableContent_redo()
{
	...
	//console.log("Redo this.mutationHistory.historyCursor="+this.mutationHistory.historyCursor);
...
function EditableContent_highlightCurrentParagraph()
{
	...
	//console.log(isRangeWithinParagraph);
	//console.logNode(par[0][0], "", "", "r:"+isRangeWithinParagraph);
...
function EditableContent_onDOMChanged()
{
	...
	console.log((i+2)+">"+(this.mutationHistory.history.length-3))
		...
		&& i+2<this.mutationHistory.history.length-1)
	{
		...
		console.log("this.mutationHistory.historyCursor: "+this.mutationHistory.historyCursor);
	}
}
