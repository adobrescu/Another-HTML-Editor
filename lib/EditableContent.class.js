...
function EditableContent(iframe, innerHTML, serializedHistory)//always an iframe, need edited doc CSS in their own space
{
	...
	this.mutationHistory=new MutationHistory(this.documentContainer, serializedHistory, [this, "onUserSelectionChanged"], [this, "onDOMChanged"]);
...
with(EditableContent)
{
	...
	prototype.onUserSelectionChanged=EditableContent_onUserSelectionChanged;
...
function EditableContent_getRanges()
{
	...
	return this.window.ContentSelection.prototype.___getRanges();
}
...
function EditableContent_surroundSelectedContentFragments(tagName, tagAttributes, select)
{
	...
	{
		console.logNode(containers[i][0], "", "");
 ...
 * 
 */
function EditableContent_onUserSelectionChanged(evt)
{
