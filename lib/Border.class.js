...
function Border_surroundElements(element1, element2)
{
	...
	this.borders[0].style.top=(top+this.document.documentElement.scrollTop+this.document.body.scrollTop-this.borderWidth)+"px";
	this.borders[0].style.width=(right-left)+"px";
	this.borders[0].style.left=(left)+"px";
	this.borders[0].className+=" hz";
	
	this.borders[1].style.top=this.borders[0].style.top;
	this.borders[1].style.width="0px";
	this.borders[1].style.height=(bottom-top+2*this.borderWidth)+"px";
	this.borders[1].style.left=(right)+"px";
	this.borders[1].className+=" vt";
	
	this.borders[2].style.top=(bottom+this.document.documentElement.scrollTop+this.document.body.scrollTop)+"px";
	this.borders[2].style.width=(right-left)+"px";
	this.borders[2].style.left=(left)+"px";
	this.borders[2].style.height="0px";
	this.borders[2].className+=" hz";
	
	
	this.borders[3].style.top=this.borders[0].style.top;
	this.borders[3].style.width="0px";
	this.borders[3].style.height=(bottom-top+2*this.borderWidth)+"px";
	this.borders[3].style.left=(left-this.borderWidth)+"px";
	this.borders[3].className+=" vt";
